...
const cases = [
  { folio: 'INC001', provider: 'HP', status: 'PENDIENTE', severity: 'AMARILLO', sla: 62 },
  { folio: 'INC002', provider: 'LENOVO', status: 'VENCIDO', severity: 'ROJO', sla: 100 },
  { folio: 'INC003', provider: 'DELL', status: 'CERRADO', severity: 'VERDE', sla: 18 }
]
...
export function App() {
  return React.createElement('div', { style: shell }, [
    React.createElement('aside', { key: 'nav', style: nav }, ['Resumen', 'Casos', 'SLA', 'Timeline', 'Proveedores'].map(i => React.createElement('div', { key: i, style: navItem }, i))),
    React.createElement('main', { key: 'main', style: main }, [
      ...
      React.createElement('table', { key: 'table', style: table }, [
        React.createElement('thead', { key: 'head' }, React.createElement('tr', {}, ['Folio','Proveedor','Estado','Criticidad','SLA'].map(h => React.createElement('th', { key: h, style: th }, h)))),
        React.createElement('tbody', { key: 'body' }, cases.map(c => React.createElement('tr', { key: c.folio }, [
          ...
          React.createElement('td', { key: 'sla', style: td }, `${c.sla}%`)
        ])))
      ]),
